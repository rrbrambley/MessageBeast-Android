...
public class ADNDatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_ACTION_MESSAGES_TABLE = "CREATE TABLE IF NOT EXISTS " + ADNDatabase.TABLE_ACTION_MESSAGES + "(" +
            ...
            ADNDatabase.COL_ACTION_MESSAGE_ASSOCIATED_MESSAGE_ID + " TEXT NOT NULL, " +
            ADNDatabase.COL_ACTION_MESSAGE_ASSOCIATED_CHANNEL_ID + " TEXT NOT NULL, " +
            "PRIMARY KEY (" + ADNDatabase.COL_ACTION_MESSAGE_CHANNEL_ID + ", " + ADNDatabase.COL_ACTION_MESSAGE_ASSOCIATED_MESSAGE_ID + " ))";
