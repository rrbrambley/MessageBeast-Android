 ...
 *
 * @see com.alwaysallthetime.messagebeast.manager.MessageManager.MessageManagerConfiguration#setLocationLookupEnabled(boolean)
 */
public class DisplayLocation implements Parcelable {
     ...
     *
     * @see com.alwaysallthetime.messagebeast.db.ADNDatabase#getPlace(String)
     * @see com.alwaysallthetime.messagebeast.db.ADNDatabase#insertOrReplacePlace(com.alwaysallthetime.adnlib.data.Place)
     */
